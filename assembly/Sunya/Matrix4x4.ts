...
export function look_at(
  ...
  const x_eye = -(f32x4.extract_lane(r0, 0) + f32x4.extract_lane(r0, 1) + f32x4.extract_lane(r0, 2)),
        y_eye = -(f32x4.extract_lane(r1, 0) + f32x4.extract_lane(r1, 1) + f32x4.extract_lane(r1, 2)),
        z_eye = -(f32x4.extract_lane(r2, 0) + f32x4.extract_lane(r2, 1) + f32x4.extract_lane(r2, 2))
...
export function multiply(
  ...
  output[4] = f32x4.extract_lane(r4, 0) + f32x4.extract_lane(r4, 1) + f32x4.extract_lane(r4, 2) + f32x4.extract_lane(r4, 3)
  output[5] = f32x4.extract_lane(r5, 0) + f32x4.extract_lane(r5, 1) + f32x4.extract_lane(r5, 2) + f32x4.extract_lane(r5, 3)
  output[6] = f32x4.extract_lane(r6, 0) + f32x4.extract_lane(r6, 1) + f32x4.extract_lane(r6, 2) + f32x4.extract_lane(r6, 3)
  output[7] = f32x4.extract_lane(r7, 0) + f32x4.extract_lane(r7, 1) + f32x4.extract_lane(r7, 2) + f32x4.extract_lane(r7, 3)
  ...
  output[ 8] = f32x4.extract_lane(r8,  0) + f32x4.extract_lane(r8,  1) + f32x4.extract_lane(r8,  2) + f32x4.extract_lane(r8,  3)
  output[ 9] = f32x4.extract_lane(r9,  0) + f32x4.extract_lane(r9,  1) + f32x4.extract_lane(r9,  2) + f32x4.extract_lane(r9,  3)
  output[10] = f32x4.extract_lane(r10, 0) + f32x4.extract_lane(r10, 1) + f32x4.extract_lane(r10, 2) + f32x4.extract_lane(r10, 3)
  output[11] = f32x4.extract_lane(r11, 0) + f32x4.extract_lane(r11, 1) + f32x4.extract_lane(r11, 2) + f32x4.extract_lane(r11, 3)
  ...
  output[12] = f32x4.extract_lane(r12, 0) + f32x4.extract_lane(r12, 1) + f32x4.extract_lane(r12, 2) + f32x4.extract_lane(r12, 3)
  output[13] = f32x4.extract_lane(r13, 0) + f32x4.extract_lane(r13, 1) + f32x4.extract_lane(r13, 2) + f32x4.extract_lane(r13, 3)
  output[14] = f32x4.extract_lane(r14, 0) + f32x4.extract_lane(r14, 1) + f32x4.extract_lane(r14, 2) + f32x4.extract_lane(r14, 3)
  output[15] = f32x4.extract_lane(r15, 0) + f32x4.extract_lane(r15, 1) + f32x4.extract_lane(r15, 2) + f32x4.extract_lane(r15, 3)
