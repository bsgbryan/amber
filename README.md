...
1. Amber is easy to get along with:<br>
  _Modern technologies and tools like [Bun]([https://www.solidjs.com/](https://bun.sh/)), [TypeScript](https://www.typescriptlang.org/), and [WebGPU](https://developer.mozilla.org/en-US/docs/Web/API/WebGPU_API) enable Amber to be simple to use & work with while also being incredibly efficient_
1. Amber is smol:<br>
